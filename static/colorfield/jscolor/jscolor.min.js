        ...
        var jsc = {
            ...
            triggerEvent: function (el, eventName, bubbles, cancelable) {
                ...
                if (typeof Event === "function") {
                    ev = new Event(eventName, {bubbles: bubbles, cancelable: cancelable})
                } else {
            ...
            eventKey: function (ev) {
                var keys = {9: "Tab", 13: "Enter", 27: "Escape"};
            ...
            parsePaletteValue: function (mixed) {
                ...
                if (typeof mixed === "string") {
                    mixed.replace(/#[0-9A-F]{3}([0-9A-F]{3})?|rgba?\(([^)]*)\)/gi, function (val) {
                        vals.push(val)
                    })
            ...
            onPaletteSampleClick: function (e) {
                ...
                if (thisObj.format.toLowerCase() === "any") {
                    thisObj._setFormat(color.format);
            ...
            pub: function (targetElement, opts) {
                ...
                this.hasAlphaChannel = function () {
                    if (this.alphaChannel === "auto") {
                        return this.format.toLowerCase() === "any" || jsc.isAlphaFormat(this.getFormat()) || this.alpha !== undefined || this.alphaElement !== undefined
                    }
                ...
                if (jsc.isButton(this.targetElement)) {
                    ...
                    if (jsc.isButtonEmpty(this.targetElement)) {
                        ...
                        if (currMinWidth < this.previewSize) {
                            jsc.setStyle(this.targetElement, {"min-width": this.previewSize + "px"}, this.forceStyle)
                        }
                    }
                }
